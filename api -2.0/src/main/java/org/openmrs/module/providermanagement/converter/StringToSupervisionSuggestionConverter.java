...
public class StringToSupervisionSuggestionConverter implements Converter<String,SupervisionSuggestion> {

    /**
     * Treats the string as the integer primary key of the Provider Role
     */
    @Override
    public SupervisionSuggestion convert(String id) {
        if (StringUtils.isBlank(id))
            return null;
        return Context.getService(ProviderSuggestionService.class).getSupervisionSuggestion(Integer.valueOf(id));
    }
}