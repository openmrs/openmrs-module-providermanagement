...
public class ExtendedProviderRole extends ProviderRole implements Serializable {
    ...
    // disable all required data handlers (save, retire, etc)
    @ManyToMany
    @JoinTable(
    ...
    private Set<ExtendedProviderRole> superviseeProviderRoles;
    ...
    public Set<ExtendedProviderRole> getSuperviseeProviderRoles() {
        return superviseeProviderRoles;
    }

    public void setSuperviseeProviderRoles(Set<ExtendedProviderRole> superviseeProviderRoles) {
