...
@Component
public class StringToProviderRoleConverter implements Converter<String, ProviderManagementProviderRole> {
	 ...
	 */
	@Override
	public ProviderManagementProviderRole convert(String id) {
