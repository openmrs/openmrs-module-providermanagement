...
public class ProviderManagementUtilsTest extends BaseModuleContextSensitiveTest{
    ...
    @Test
    public void shouldAssignProviderToSupervisor() throws PersonIsNotProviderException, InvalidSupervisorException, ProviderAlreadyAssignedToSupervisorException {
    ...
    @Test
    public void shouldAssignPersonToSupervisor() throws PersonIsNotProviderException, InvalidSupervisorException, ProviderAlreadyAssignedToSupervisorException {
    	Provider provider = new Provider();
    	provider.setIdentifier("1000X");
    	Person person = Context.getPersonService().getPerson(6);
    	Person supervisor = Context.getPersonService().getPerson(2);
